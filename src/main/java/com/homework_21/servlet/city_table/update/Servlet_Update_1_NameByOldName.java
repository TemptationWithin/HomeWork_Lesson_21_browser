...
@WebServlet("/update/1")
public class Servlet_Update_1_NameByOldName extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (manager.isNameContainsInDatabase(oldName)){
            manager.updateNameByOldName(oldName,newName);
            response.sendRedirect("/HomeWork_Lesson_21_war_exploded/update/1");
        } else {
            pw.println("<html>");
            ...
            pw.println("<form align=\"center\" action=\"/HomeWork_Lesson_21_war_exploded/update/1\">");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<p><b> city name: </b><br>  <input type=\"text\" name = \"oldName\" size=" + 20 + "required pattern=\"[A-Za-z]*\">");
        pw.println("<p><b> new city name: </b><br>  <input type=\"text\" name = \"newName\" size=" + 20 + "required pattern=\"[A-Za-z]*\">");
