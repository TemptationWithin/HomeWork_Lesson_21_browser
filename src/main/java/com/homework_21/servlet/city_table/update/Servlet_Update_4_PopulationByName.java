...
@WebServlet("/update/4")
public class Servlet_Update_4_PopulationByName extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final int newPopulation = Integer.parseInt(request.getParameter("newPopulation"));
        if (manager.isNameContainsInDatabase(name)){
            manager.updatePopulationByCityName(name, newPopulation);
            response.sendRedirect("/HomeWork_Lesson_21_war_exploded/update/4");
        } else {
            pw.println("<html>");
            ...
            pw.println("<form align=\"center\" action=\"/HomeWork_Lesson_21_war_exploded/update/4\">");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<tr>");
        pw.println("<th>");
        pw.println("<h2 align=\"center\"> <u> Update form </u></h2>");
        ...
        pw.println("<p><b> new population: </b><br>  <input type=\"text\" name = \"newPopulation\" size=" + 20 + "required pattern=\"[0-9]*\">");
