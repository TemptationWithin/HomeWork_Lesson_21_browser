...
@WebServlet("/read/3")
public class Servlet_Read_3_CitiesByCountryCode extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<String> cityList = manager.readByCountryCode(countryCode);
            if (cityList.isEmpty()){
                pw.println("<html>");
                ...
                pw.println("<form align=\"center\" action=\"/HomeWork_Lesson_21_war_exploded/read/3\">");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<p><b> country code: </b><br>  <input type=\"text\" name = \"countryCode\" size=" + 20 + "required pattern=\"[A-Z]{3}\">");
